...
import { FilterDataCon, MainContainer, TabContainer } from "./styles/smallPetDetail.style";
...
const SmallPetFoodDetail = () => {
  ...
  const relatedSmall = products.filter((item)=> item.type === "Small Pet Food")
  const likeSmall = products.filter((item) => item.type === "Dog Food")
  return (
    <MainContainer>
      <FilterDataCon>
        ...
        <div className="small-pet-detail-back">
          <h1>{product.title}</h1>
...
export default SmallPetFoodDetail;
