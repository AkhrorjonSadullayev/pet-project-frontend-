...
import { FilterDataCon, MainContainer, TabContainer } from "./styles/catDetail.style";
...
import { AlsoLikeContainer, RelaitedProContainer } from "./styles/catDetail.style";
...
const CatFoodDetail = () => {
  ...
  const relatedDogFood = products.filter((item) => item.type === "Dog Food");
  const likeDogFood = products.filter((item) => item.type === "Cat Food");
  ...
  return (
    <MainContainer>
      <FilterDataCon>
        ...
        <div className="cat-food-detail-back">
          <h1>{product.title}</h1>
