...
const DogFoodDetail: React.FC = () => {
  ...
  const relatedDogFood = products.filter((item) => item.type === "Accessories");
  const likeDogFood = products.filter((item) => item.type === "Small Pet Food");
  ...
  return (
    <MainContainer>
      <FilterDataCon>
        ...
        <div className="dog-food-detail-back">
          <h1>{product.title}</h1>
