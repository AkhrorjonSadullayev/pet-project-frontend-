...
const RabbitFoodDetail: React.FC = () => {
  ...
  const relatedRabbit = products.filter((item)=> ["Rabbit Food","Rabbit"].includes(item.type))
  const likeRabbit = products.filter((item) => item.type === "Small Pet Food")
  ...
  return (
    <MainContainer>
      <FilterDataCon>
        ...
        <div className="rabbit-food-detail-back">
          <h1>{product.title}</h1>
...
export default RabbitFoodDetail;
