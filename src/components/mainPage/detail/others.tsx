...
const OthersDetail: React.FC = () => {
  ...
  const relatedDog = products.filter((item) => item.type === "Dog");
  const likeCatFood = products.filter((item) => item.type === "Cat Food");
  return (
    <MainContainer>
      <FilterDataCon>
        {/* Header */}
      ...
      <div className="others-detail-back">
        <h1>{product.title}</h1>
              ...
              <div key={item._id} className="product-img-con">
                ...
                >
                  ...
                  <div className="price">
                    ...
                    >
                      <p className="decoration">${item.price}</p>
                    </div>
                  </div>
                </Link>
              </div>
