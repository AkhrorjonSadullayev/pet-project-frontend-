...
const CatDetail: React.FC = () => {
  ...
  const relatedCat = products.filter((item) => item.type === "Dog");
  const likeCat = products.filter((item) => item.type === "Cat Food");
  ...
  return (
    <MainContainer>
          ...
          <div className="zoom-container" style={{ position: "relative" }}>
                <div
                  ...
                  style={{
                    ...
                    height: "500px",
                    borderRadius: "10px", // Sizning tasvir bo'yi
                    overflow: "hidden",
                    position: "relative",
                  }}
                >
      ...
      <RelaitedProContainer>
        <div className="grid">
        {likeCat.map((item,index) => (
            <div key={index}>
              <div className="product-img-con">
                <Link
                  to={`/pet-food/cat-food/${item._id}`}
                  style={{ textDecoration: "none" }}
                >
                  <img  className="img-class" src={item.main} alt="product-img" />
                  <div className="price">
