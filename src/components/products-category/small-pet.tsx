...
import { MainContainer } from "./styles/small-pet.style"
...
const SmallPetComponent = () => {
  ...
  const filteredOriginal = products.filter((item) => {
   ...
   const matchesType = item.type === "Small Pet Food";
            ...
            <AccordionDetails>
              <div>
                ...
                <FormControlLabel
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("Dog Food")}
                      onChange={() => handleLocationChange("Dog Food")}
                        sx={{
                            color: "#7F4D4F",
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("Cat Food")}
                      onChange={() => handleLocationChange("Cat Food")}
                        sx={{
                            color: "#7F4D4F",
                            "&.Mui-checked": { color: "#7F4D4F" },
                        }}
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("Rabbit Food")}
                      onChange={() => handleLocationChange("Rabbit Food")}
                        sx={{
                            color: "#7F4D4F",
                            "&.Mui-checked": { color: "#7F4D4F" },
                        }}
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("Parrot Food")}
                      onChange={() => handleLocationChange("Parrot Food")}
                        sx={{
                            color: "#7F4D4F",
                            "&.Mui-checked": { color: "#7F4D4F" },
                        }}
