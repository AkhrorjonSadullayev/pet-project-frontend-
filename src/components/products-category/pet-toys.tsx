...
const PetToysComponent = () => {
  const data = PetoysProducts.PetToysProductList
  const bestSeller = PetoysProducts.PetToysProductList.filter(bestSeller =>{
      ...
      >
        ...
        <Accordion
          ...
          >
            ...
            <AccordionDetails>
            {bestSeller.map((list) => (
              <Link to={`/pet-toys/${list.id}`} style={{ textDecoration: 'none',color:'black' }}>
              <div style={{ display: "flex", gap: "20px" }}>
                    <img
                        src={list.PetToys.image}
                        alt="dog-food-img"
                        width={"59px"}
                        height={"72px"}
                      />
                      <div>
                        <p>{list.PetToys.name}</p>
                        <div
