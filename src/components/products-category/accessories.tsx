...
import "./styles/accessories.style";
import { MainContainer } from "./styles/accessories.style";
...
const AccessoriesComponent = () => {
  const bestSeller = AccessoriesProducts.AccessoriesProductList.filter(bestSeller =>{
  ...
  const filteredOriginal = products.filter((item) => {
   ...
   const matchesType = item.type === "Accessories";
  ...
  return (
    <MainContainer>
      <div className="accessories-back">
        <h1>Accessories</h1>
      ...
      >
        ...
        <Accordion
              ...
              <div>
                <FormGroup>
                  <FormControlLabel
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("For Dog")}
                      onChange={() => handleLocationChange("For Dog")}
                        sx={{
                            color: "#7F4D4F",
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("For Cat")}
                      onChange={() => handleLocationChange("For Cat")}
                        sx={{
                            color: "#7F4D4F",
                            "&.Mui-checked": { color: "#7F4D4F" },
                        }}
                  ...
                  />
                    ...
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("For Parrot")}
                      onChange={() => handleLocationChange("For Parrot")}
                        sx={{
                            color: "#7F4D4F",
                            "&.Mui-checked": { color: "#7F4D4F" },
                        }}
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                      checked={selectedLocation.includes("For Rabbit")}
                      onChange={() => handleLocationChange("For Rabbit")}
                        sx={{
                            color: "#7F4D4F",
                            "&.Mui-checked": { color: "#7F4D4F" },
                        }}
          ...
          >
            ...
            <AccordionDetails>
            {bestSeller.map((list) => (
              <Link to={`/accessories/${list.id}`} style={{ textDecoration: 'none',color:'black' }}>
              <div style={{ display: "flex", gap: "20px" }}>
                    <img
                        src={list.Accessories.image}
                        alt="dog-food-img"
                        width={"59px"}
                        height={"72px"}
                      />
                      <div>
                        <p>{list.Accessories.name}</p>
                        <div
                        ...
                        >
                          ...
                          >
                            ${list.Accessories.OriginalPrice}
                          </p>
                          <p style={{ color: "#7F4D4F" }}>
                          ${list.Accessories.Price}
                          </p>
                        </div>
                      </div>
                      </div>
